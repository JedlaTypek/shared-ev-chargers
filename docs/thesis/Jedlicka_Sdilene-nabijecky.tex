...
... }
	...
	\begin{enumerate}
		\item \textbf{OCPP CP Simulator} (autor \textit{shiv3})\footnote{Dostupné z: \url{https://github.com/shiv3/ocpp-cp-simulator}}: Webový nástroj k jednoduchému přepínání stavů konektoru, \texttt{StartTransaction}, \texttt{MeterValues} a \texttt{StopTransaction}.
...
\begin{thebibliography}{99}
	...
	%% 2. OCPP SPECIFIKACE (Tvůj požadavek - velmi důležité)
	...
	%% 3. TECHNICKÁ DOKUMENTACE (Toto ti chybělo a je to nutné)
	...
	%% 4. LaTeX ZDROJE (Z šablony - můžeš nechat, vypadá to, že jsi studoval jak psát)
	\bibitem{LaTeXprirucka} OETIKER, Tobias et al. \textit{Ne příliš stručný úvod do systému LaTeX2e} [online]. 1998 [cit. 2020-08-24]. Dostupné z: \url{https://www.jaroska.cz/elearning/informatika/typografie/lshort2e-cz.pdf}
	
	\bibitem{wikibooksLaTeX} \textit{Wikibooks: LaTeX} [online]. Wikimedia Foundation, 2001- [cit. 2020-08-24]. Dostupné z: \url{https://en.wikibooks.org/wiki/LaTeX}
